...
class FMNIST(Dataset):
    def __init__(self, set_name,transform = None):
        ...
        self.data = DATA_PATH+'/'+set_name+'_images.npy'#torch.from_numpy(DATA_PATH+set_name+'_images.npy').float()

        self.target = DATA_PATH+'/'+set_name+'_labels.npy'#torch.from_numpy(DATA_PATH+set_name+'_labels.npy').float()
